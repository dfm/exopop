...
\begin{eqnarray}
\ln p(\Delta\binheights\,|\,\smoothreg_\period,\,\smoothreg_\radius) &=&
-\frac{1}{2}\sum_{i=1}^{N_\period-1}\sum_{j=1}^{N_\radius-1} \left [
\frac{[\Delta_\period\binheights_{ij}]^2}{\smoothreg_\period}
\frac{[\Delta_\radius\binheights_{ij}]^2}{\smoothreg_\radius}
\right] \\
&& -\frac{1}{2}\,(N_\period-1)\,(N_\radius-1)\,
\ln (\smoothreg_\period\,\smoothreg_\radius)
\quad.
\end{eqnarray}
