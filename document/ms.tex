...
of Earth analogs \gammaearth\ which we define as \emph{the number density of
planets per natural logarithmic bin in period and radius evaluated at the
location of Earth}
\begin{eqnarray}
\gammaearth &=&
...
distribution of planets in a small bin in radius is flat and extrapolated from
their sample.
We relax this assumption and extrapolate by only assuming that the
occurrence rate function is ``smooth'' in period and radius.
We enforce this constraint by applying a flexible Gaussian process
