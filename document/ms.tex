...
scientific interest to study what we can say about the exoplanet occurence
...
more accurate estimates of the underlying occurence rate than the standard
...
We relax these assumptions by modeling the occurence rate as a
...
Having developed this probabilistic framework for occurence rate inferences
...
\Fig{real-results} shows posterior samples from the inferred occurence rate
distribution as a function of period and radius conditioned on the catalog.
The marginalized distributions are qualitatively consistent with the occurence
rate functions measured by \citet{petigura}.
