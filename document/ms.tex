...
of the posterior probabilities that are being measured.
In this case, these parameters are radius ratio and stellar radius instead of
just the physical radius.
