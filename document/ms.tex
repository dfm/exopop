...
%  * Sun Solar Earth all capitalized when referring to our peeps, even as in "extra-Solar"
%  * eqnarrys ONLY
%  * that is all.
%
...
In the next \sectionname, we introduce the concept of hierarchical inference, how
