...
\eq{crazylike} because it involves the numerical evaluation of an extremely
 high dimensional---the number of physical parameters times the number of
targets---and computationally costly integral.
...
A very simple example of such an inference is a procedure that should be very
familiar: the histogram.
In the limit of negligible uncertainties, the maximum marginalized likelihood
for the occurence rate is a histogram of the objects in the catalog (see
\app{histogram} for the derivation).
