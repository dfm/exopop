...
previous study of the period and radius distribution of the Earth-analog
...
&=& \rate_\ratepars(\entry)\,\completeness(\entry)\,
...
Under this assumption, the likelihood of a catalog \catalog\ conditioned on a
set of parameters \ratepars\ is (see Appendix XXXXX for a derivation)
...
The ``likelihood function'' given in \eq{true-like}\ldots
