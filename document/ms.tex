...
analogs.
We relax these assumptions, only requiring that the occurrence rate be a
smooth function of period and radius (using a Gaussian process) and find that
the rate of Earth analogs per star is about 0.02 (per natural logarithmic bin
in period and radius) with large uncertainty.
