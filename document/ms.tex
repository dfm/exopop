...
occurence rate of exoplanets only through the catalog.
In our case, this assumption qualitatively means that the signals found in the
light curves depend only on the actual planet properties and not on their
distributions.
...
\dfmtodo{describe the Gaussian process prior on the bin heights.}
