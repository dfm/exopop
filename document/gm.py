...
pgm.add_node(daft.Node("rp", r"$\rp_{nk}$", 1.0, 3.0))
pgm.add_node(daft.Node("ror", r"$\ror_{nk}$", 2.0, 3.0))
pgm.add_node(daft.Node("rorobs", r"$\rorobs_{nk}$", 2.5, 2.5, observed=True))
pgm.add_node(daft.Node("isobs", r"$\isobs_{nk}$", 2, 2, observed=True))
